        ...
        do{
            ...
            if(floor>0){
                ...
                if(room>0){
                    ...
                    System.out.println(">>>>>>>>>  You have successfully set up a condo  <<<<<<<<<<");
                    System.out.println("You have set up a condo that has : ");
                    // ternary operator
                    System.out.println("Floor = "+floor + " floor"+(floor>=4?"s":"")); // 1 floor , 2 floors not 1 floors
                    System.out.println("Room  = "+ room + " room"+(room>=4?"s":"")); // 1 room , 2 rooms not 1 rooms
        ...
        do{
            ...
            switch (option){
                        ...
                        if(selectedFloor>0 && selectedFloor<=floor){
                            ...
                            if(selectedRoom>0 && selectedRoom<=room){
                                ...
                                if(condo[selectedFloor-1][selectedRoom-1]!=null){
                                    ...
                                    condo[selectedFloor-1][selectedRoom-1] = input.next();
                        ...
                        if(sellFloor>0 && sellFloor <= floor){
                            ...
                            if(sellRoom>0 && sellRoom <=room){
                                ...
                                if(condo[sellFloor-1][sellRoom-1]==null){
                                    System.out.println("Error: You cannot sell this condo ! Because it's not own by anybody......");
                                }else {
                ...
                case 4 :
                    ...
                    // condo.length
//                 System.out.println(" condo.length : "+condo.length);
//                 System.out.println(" condo[0].lengh : "+ condo[0].length);
